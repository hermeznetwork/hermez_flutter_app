class Transaction {
  ...
  Transaction({this.id, this.type, this.fromAccountIndex, this.toAccountIndex,
    this.toEthereumAddress, this.toBjj, this.tokenId, this.amount, this.fee, this.nonce,
    this.state, this.signature, this.timestamp, this.batchNum, this.rqFromAccountIndex,
    this.rqToAccountIndex, this.rqToEthereumAddress, this.rqToBJJ, this.rqTokenId,
    this.rqAmount, this.rqFee, this.rqNonce, this.tokenSymbol});
