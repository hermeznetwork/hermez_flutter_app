...
enum ReceiverType { REQUEST, SEND }
      ...
      children: <Widget>[
        ...
        Row(
          children: <Widget>[
            ...
            Expanded(
              child: Text("Name, Phone, Email, Eth address",
                  maxLines: 1,
                  style: TextStyle(
                    color: Colors.grey,
                    fontSize: 16.0,
    ...
    return Expanded(
      child: Container(
          child: ListView.builder(
              shrinkWrap: true,
              itemCount:
                  5, //set the item count so that index won't be out of range
              ...
              itemBuilder: (context, i) {
                ...
                final String name = _contactNames[index % _contactNames.length];
                final String subtitle =
                    _contactSubtitles[index % _contactSubtitles.length];
                return _buildRow(
                    color, name, subtitle, index == 0); //build the row widget
              })),
    );
  }

  Widget _buildRow(
      MaterialColor color, String name, String subtitle, bool isChecked) {
        ...
        children: <Widget>[
          ...
          Expanded(
            child: RaisedButton(
              ...
              child: Text(
                  widget.arguments.receiverType == ReceiverType.SEND
                      ? "Send"
                      : "Request",
                  style: TextStyle(
                    color: Colors.white,
      ...
      children: <Widget>[
        Column(
          ...
          children: <Widget>[
            ...
            Text("from DAI ▼",
                textAlign: TextAlign
                    .center, //"\$${EthAmountFormatter(tokenBalance).format()}",
                style: TextStyle(
                    fontFamily: 'ModernEra',
                    fontWeight: FontWeight.w700,
                    color: Colors.grey,
