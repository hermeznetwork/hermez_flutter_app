      ...
      child: Column(
        children: <Widget>[
          ...
          ListTile(
              ...
              child: ListTile(// get the first letter of each crypto with the color
        ...
        Container(
          ...
          ListTile(
            title: Align(
              ...
              child: Container(
                padding: EdgeInsets.only(left:5.0, top: 30.0, bottom: 30.0),
                child: Text("Open wallet in block explorer",
                  style: TextStyle(fontFamily: 'ModernEra',
                      fontWeight: FontWeight.w800,
                      color: Colors.grey,
                      fontSize: 16)
          ...
          ListTile(
            title: Align(
              ...
              child: Container(
                padding: EdgeInsets.only(left:5.0, top: 30.0, bottom: 30.0),
                child: Text("Default currency - " +  store.state.defaultCurrency.toString().split('.').last,
                  style: TextStyle(fontFamily: 'ModernEra',
                      fontWeight: FontWeight.w800,
                      fontSize: 16)
                  ,textAlign: TextAlign.left,
            ...
            trailing: Container(
                ...
                child:Icon(Icons.arrow_forward_ios)),
            onTap: () {
              Navigator.of(context).pushNamed("/currency_selector", arguments: store);
            },
          ),
          Container(
              padding: EdgeInsets.only(left:20.0, right: 20.0),
          ...
          ListTile(
            title: Align(
              ...
              child: Container(
                padding: EdgeInsets.only(left:5.0, top: 30.0, bottom: 30.0),
                child: Text("Force exit (advanced)",
                  style: TextStyle(fontFamily: 'ModernEra',
                      fontWeight: FontWeight.w800,
                      fontSize: 16)
                  ,textAlign: TextAlign.left,
